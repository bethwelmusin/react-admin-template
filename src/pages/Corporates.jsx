...
const Corporates = () => (
  <div className="mt-4 mx-3">
    <form className="flex items-center pb-3 md:mt-4">
      ...
      <button
        type="submit"
        className="p-2.5 ml-2 text-sm font-medium text-white bg-sky-500 hover:bg-blue-800 rounded-lg border focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        <svg
          className="w-5 h-5"
          fill="none"
